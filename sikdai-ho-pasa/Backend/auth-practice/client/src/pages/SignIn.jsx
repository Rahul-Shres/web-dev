              ...
              <div className="p-4 sm:p-7">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <Link to='/sign-up'>
          <span  className="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" > Sign up here</span>
        </Link>
                  </p>
                </div>
                ...
                <div className="mt-5">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <Link to='/sign-up'>
          <span  className="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" > Sign Up</span>
        </Link>
                  </p>
