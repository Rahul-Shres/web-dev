...
import {  forgotPassword, loginAdmin, verifyotp } from "../../../../store/adminAuth"
...
const VerifyOtpAdmin = () => {
  ...
  console.log(forgotPasswordData)
    ...
    const otpData = {
        ...
        otp: parseInt(otp, 10) // Convert the string to a number using parseInt
      }
      ...
      <div className="mt-5">
        ...
        <form  onSubmit={handleSubmit}>
          <div className="grid gap-y-4">
            {/* <!-- Form Group --> */}
            <div>
              <label for="otp" className="block text-sm mb-2 dark:text-white">OTP</label>
              <div className="relative">
                <input type="text" id="otp" name="otp" className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="otp-error"  onChange={(e)=>setOtp(e.target.value)} />
              ...
              <p className="hidden text-xs text-red-600 mt-2" id="otp-error">Please include a valid email address so we can get back to you</p>
            </div>
            {/* <!-- End Form Group -->
            ...
            <button type="submit" className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Verify</button>
          </div>
        </form>
        {/* <!-- End Form --> */}
      </div>
