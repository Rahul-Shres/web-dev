              ...
              <div className="flex flex-col rounded-xl dark:bg-black">
                <div className="flex-auto p-4 md:p-6 dark">
                  <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                    "Kaleidoscope Music Academy has transformed my musical journey. The instructors are not just teachers; they are mentors who genuinely care about your growth. The personalized approach to learning made each session enjoyable and effective. I've seen incredible progress, and my passion for music has soared to new heights!"
                  </p>
                </div>

                <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-black">
