...
const HeroSection = () => {
  ...
  <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
    <div>
      <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your Abroad journey with <span className="text-blue-600">Self Apply Center</span></h1>
      <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">At Self Apply Center, we open doors to a world of academic possibilities. Your journey begins here, where dreams take flight, and education transcends boundaries.</p>
      ...
      <div className="mt-7 grid gap-3 w-full sm:inline-flex">
        ...
        <div
    className="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold shadow text-indigo-600 transition-all duration-150 ease-in-out rounded-lg gap-x-2 hover:pl-10 hover:pr-6 bg-gray-50 dark:bg-blue-600 dark:text-white dark:hover:text-gray-200 dark:shadow-none group"
  >
    <span
    ...
    <div className="relative ms-4">
      <img className="w-full rounded-md" src="https://images.unsplash.com/photo-1556146385-97d8a0b5e66b?q=80&w=1378&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Image Description" />
